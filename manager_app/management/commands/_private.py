...
def add_starters():
    starters = (
        (
            "Mięsa pieczone (450g): schab, karkówka marynowana w ziołach, boczek, cygański",
            79,
        ),
        ...
        ("Pieczywo, masło", 1),
        (
            "Tatar wołowy podawany z siekana cebulą, korniszonem i marynowanymi grzybkami",
            95,
        ),
        (
            "Parfait z wątróbki drobiowej podane na grzance ziołowej z rukolą i odrobiną musu figowego, 8szt",
            49,
        ),
        ("Carpaccio z polędwicy wołowej na rukoli z kaparami i parmezanem", 99),
        ("Smalec z ogórkiem małosolnym (200g)", 19),
        (
            "Tatar z marynowanego łososia z siekaną czerwoną cebulką, kaparami i czarnymi oliwkami",
            95,
        ),
        ...
        (
            "Mini gofry szpinakowe z ziołową ricottą, rukolą i wędzonym łososiem 8 szt",
            59,
        ),
        (
            "Marynowane papryczki chilli faszerowane ziołowym serkiem, podawane na rukoli z "
            "grzankami i balsamicznym winegretem 8 szt",
            49,
        ),
        ("Jajka w majonezie 12 połówek", 25),
        (
            "Sałata z grillowanym kurczakiem, warzywami julienne i sosem sojowo – imbirowym",
            89,
        ),
        (
            "Sałata z liści szpinaku z sosem gorgonzola z orzechami włoskim,i, boczkiem i pomidorkami cherry",
            89,
        ),
...
def add_dishes():
    dishes = (
        ("Śledź w oleju z cebulką", "Przystawka", 16),
        ("Śledź w śmietanie z jabłkiem", "Przystawka", 16),
        ("Śledź smażony w zalewie octowej", "Przystawka", 16),
        (
            "Tatar z wołowiny z siekaną cebulą, korniszonem i marynowanymi podgrzybkami",
            "Przystawka",
            32,
        ),
        (
            "Tatar z marynowanego łososia z siekaną czerwoną cebulą, kaparami i czarnymi oliwkami",
            "Przystawka",
            36,
        ),
        (
            "Carpaccio z polędwicy wołowej z oliwą truflową, kaparami parmezanem i rukolą",
            "Przystawka",
            36,
        ),
        ...
        (
            "Kaczka pieczona z sosem jabłkowo-żurawinowym z kopytkami i zasmażanymi buraczkami",
            "Danie główne",
            59,
        ),
        (
            "Golonka gotowana podawana z kapustą zasmażaną, chrzanem i musztardą",
            "Danie główne",
            49,
        ),
        (
            "Ozorki wołowe w delikatnym sosie chrzanowym z paloną kaszą i chipsami bekonowymi",
            "Danie główne",
            39,
        ),
        (
            "Tradycyjny kotlet schabowy z purée ziemniaczanym i kapustą zasmażaną",
            "Danie główne",
            36,
        ),
        ("Stripsy z kurczaka z frytkami i z mizerią", "Danie główne", 29),
        (
            "Tagliatelle rosso z kurczakiem, szpinakiem, suszonymi pomidorami i parmezanem",
            "Danie główne",
            36,
        ),
        (
            "Tagliatelle nero z krewetkami (5 szt.), rukolą i pomidorkami cherry",
            "Danie główne",
            39,
        ),
        (
            "Pieczony filet z łososia na blanszowanym szpinaku z kaszą bulgur i z salsą mango chili",
            "Danie główne",
            59,
        ),
        (
        ...
        (
            "Świeży szpinak z panierowanymi kalmarami (8 szt.) i salsą pomidorową",
            "Danie główne",
            32,
        ),
        (
            "Sałata z marynowanym łososiem, owocami, pomidorkami cherry i dressingiem mango-chilli",
            "Danie główne",
            36,
        ),
        (
        ...
        (
            "Karmelizowane płatki migdałów z musem mascarpone i świeżymi truskawkami",
            "Deser",
            19,
        ),
        (
            "Gorący suflet czekoladowy na musie malinowym z lodami waniliowymi",
            "Deser",
            19,
        ),
        (
            "SpecialMalinowa rozkosz – Lody waniliowe z gorącym musem malinowym",
            "Deser",
            19,
        ),
...
def generate_random_hour():
    return (
        datetime(1000, 1, 1, hour=10) + randrange(1, 20) * timedelta(minutes=30)
    ).time()
